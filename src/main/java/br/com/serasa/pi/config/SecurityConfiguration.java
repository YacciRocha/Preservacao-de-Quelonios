...
public class SecurityConfiguration {
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        .and()
	        ...
	        .antMatchers("/api/usuario**").hasAnyRole("ADMIN","COORDENADOR","VOLUNTARIO")
	        .antMatchers("/api/viagem**").hasAnyRole("ADMIN","COORDENADOR","VOLUNTARIO")
	        .antMatchers("/api/ciclo**").hasAnyRole("ADMIN","COORDENADOR","VOLUNTARIO")
	        .antMatchers("/api/municipio**").hasAnyRole("ADMIN","COORDENADOR","VOLUNTARIO")
	        .antMatchers("/api/comunidade**").hasAnyRole("ADMIN","COORDENADOR","VOLUNTARIO")
