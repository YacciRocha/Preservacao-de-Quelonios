...
public class SecurityConfiguration {
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        .and()
	        ...
	        .antMatchers("/api/usuario**").hasAnyRole("ADMIN","COORDENADOR")
	        .antMatchers("/api/viagem**").hasAnyRole("ADMIN","COORDENADOR")
	        .antMatchers("/api/ciclo**").hasAnyRole("ADMIN","COORDENADOR")
	        .antMatchers("/api/municipio**").hasAnyRole("ADMIN","COORDENADOR")
	        .antMatchers("/api/comunidade**").hasAnyRole("ADMIN","COORDENADOR")
